...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-gray-800 p-4 sm:p-6 md:p-8">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <button
              type="submit"
              className="w-full py-2.5 sm:py-3 bg-white text-gray-800 text-sm sm:text-base font-semibold rounded-full hover:bg-gray-100 transition-colors shadow-lg"
            >
              Sign In
            </button>
